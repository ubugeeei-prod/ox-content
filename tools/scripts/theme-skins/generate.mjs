...
function glTs(skin, js) {
  const doc = [
    ...
    " *",
    ` * Generated from tools/scripts/theme-skins/js/${skin.id}.js; edit that file and`,
 ...
 *
 * Generated from \`tools/scripts/theme-skins/skins/${skin.id}.css\`; edit that file and
 * run \`node tools/scripts/theme-skins/generate.mjs\` rather than editing this by hand.
 */
