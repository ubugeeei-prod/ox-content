...
// `tools/benchmarks/bundle-size/parse-benchmark.mjs --json <path>`.
//
...
//
//   node tools/benchmarks/bundle-size/parse-benchmark.mjs --runs 7 --json /tmp/b.json
//   node tools/scripts/render-benchmark-charts.mjs /tmp/b.json --size large
//
