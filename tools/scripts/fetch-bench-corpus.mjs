 ...
 * and stages them under `tools/benchmarks/corpus/<project>/` for use by
 * `cargo bench -p ox_content_parser --bench corpus` and the JS comparison
 * benchmarks in `tools/benchmarks/bundle-size/`.
 *
 ...
 *
 * The fetched trees live entirely under `tools/benchmarks/corpus/`, which is
...
const CORPUS_ROOT = join(REPO_ROOT, "tools", "benchmarks", "corpus");
