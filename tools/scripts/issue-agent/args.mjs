export const usage = `Usage:
  node tools/scripts/issue-agent.mjs run --issue <number> [--repo owner/name] [--base main]
  node tools/scripts/issue-agent.mjs watch [--repo owner/name] [--base main] [--interval 60] [--backfill]
  node tools/scripts/issue-agent.mjs list [--repo owner/name]
