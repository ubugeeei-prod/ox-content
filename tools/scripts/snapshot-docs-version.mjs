#!/usr/bin/env node
// Usage: node tools/scripts/snapshot-docs-version.mjs --tag v2.90.0 --prefix 2.90
//
...
if (!args.tag || !args.prefix || !/^[a-z0-9](?:[a-z0-9.-]{0,62})$/.test(args.prefix)) {
  console.error("Usage: node tools/scripts/snapshot-docs-version.mjs --tag v2.90.0 --prefix 2.90");
  process.exit(1);
}
