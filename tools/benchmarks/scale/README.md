...
```bash
vp install                       # tools/benchmarks/scale is a workspace package
node tools/benchmarks/scale/run.mjs    # all three suites
node tools/benchmarks/scale/run.mjs --suite build --pages 3200 --json out.json
```
