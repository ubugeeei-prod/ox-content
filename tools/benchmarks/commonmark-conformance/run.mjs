 ...
 *   node tools/benchmarks/commonmark-conformance/run.mjs --json results.json
 *
 * The committed `results.json` feeds the "CommonMark" column in the README and
 * docs benchmark tables via `tools/scripts/render-benchmark-tables.mjs`.
 */
...
const NATIVE_DIR = join(ROOT, "tools", "benchmarks", "native-competitors");
