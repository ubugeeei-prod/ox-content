...
use crate::CodeImportOptions;

#[derive(Clone)]
pub(super) struct ResolvedCodeImportOptions {
    root_dir: PathBuf,
    source_path: Option<PathBuf>,
}

pub(super) fn resolve(
    options: Option<&CodeImportOptions>,
    source_path: Option<&str>,
) -> Option<ResolvedCodeImportOptions> {
    let options = options?;
    ...
    Some(ResolvedCodeImportOptions {
        root_dir,
...
pub(super) fn transform(
    source: &str,
    options: &ResolvedCodeImportOptions,
...
fn render_code_import(value: &str, options: &ResolvedCodeImportOptions) -> Result<String, String> {
    if value.is_empty() {
