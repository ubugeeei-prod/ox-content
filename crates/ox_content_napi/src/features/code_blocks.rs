...
#[derive(Clone, Debug, PartialEq, Eq)]
pub(crate) struct CodeBlockDiagnostic {
    pub rule_id: String,
    pub severity: String,
    pub message: String,
    pub line: u32,
...
pub(crate) fn extract_code_blocks(source: &str) -> Vec<ExtractedCodeBlock> {
...
pub(crate) fn extract_docs_tests(
    source: &str,
    options: Option<&JsDocsTestOptions>,
