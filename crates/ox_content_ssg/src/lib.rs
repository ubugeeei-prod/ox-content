...
pub use html::{
    ...
    LocalePath, NavGroup, NavItem, PageChromeFlags, PageData, PagerOverride, READER_CHROME_CSS,
    READER_CHROME_JS, READER_CHROME_RUNTIME_JS, ReaderChrome, RenderedHead, ResolvedHead,
    ResolvedTag, SectionIndexItem, SectionIndexStyle, SiteHead, SocialLink, SocialLinks, SsgConfig,
    ...
    apply_reader_chrome, generate_bare_html, generate_bare_page, generate_html,
