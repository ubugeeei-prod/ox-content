...
| Extra syntax       | `wikiLinks`, `emojiShortcodes`, `attrs`, `crossReferences` / `xrefs`, `cjkEmphasis`, `containers`, `badges`, `notByAi`, `keyboardKeys`, `abbreviations`, `definitionLists`, `magicLinks`                                                                           | `false`              | [Syntax Extensions](./built-in/syntax-extensions.md)                                       |
