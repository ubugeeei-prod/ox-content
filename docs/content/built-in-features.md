...
| [RSS / Atom / JSON feeds](./built-in/feeds.md)         | Opt-in machine-readable feeds written next to generated HTML              |
...
| Feeds            | `feeds`                                                                                                       | `false`              | [RSS / Atom / JSON feeds](./built-in/feeds.md)         |
