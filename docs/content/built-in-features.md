...
| [Cross References](./built-in/cross-references.md)          | Opt-in labeled links for sections, figures, and tables                      |
| [Citations](./built-in/citations.md)                        | Opt-in CSL JSON citations and generated bibliography entries                |
| [BudouX](./built-in/budoux.md)                              | Opt-in build-time phrase segmentation for Japanese line breaking            |
| [Custom Containers](./built-in/containers.md)               | Opt-in `::: tip` / `::: details` callout blocks                             |
| [Conditional Blocks](./built-in/conditional-blocks.md)      | Opt-in static `::: if` / `::: else` branches                                |
...
| [Graphviz DOT Diagrams](./built-in/graphviz.md)             | DOT graph fences rendered to sanitized static SVG                           |
...
| [Custom host lifecycle](./built-in/custom-host.md)          | Vite loading, dev routing, invalidation, and writes for custom HTML hosts   |
| [Document assets](./built-in/document-assets.md)            | Typed script, style, link, manifest, and self-hosted asset tags             |
...
| Custom HTML host   | `oxContentCustomHost`                                                                                                                                                                                                                                              | public API           | [Custom host lifecycle](./built-in/custom-host.md)                                         |
| Document assets    | `renderDocumentAssets`                                                                                                                                                                                                                                             | public API           | [Document assets](./built-in/document-assets.md)                                           |
| Custom SSG outputs | `planSsgOutputs`, `writeResourceFiles`, `writeMarkdownCompanions`, `renderFeedFiles`, `writeFeedFiles`, `writeSiteMapFiles`                                                                                                                                        | public API           | [SSG output primitives](./built-in/ssg-output.md)                                          |
...
| Opt-in embeds      | `embeds.pm`, `embeds.twitter`, `embeds.reddit`, `embeds.bluesky`, `embeds.qiita`, `embeds.zenn`, `embeds.packageRegistry`, `embeds.spotify`, `embeds.appleMusic`, `embeds.speakerDeck`, `embeds.audio`, `embeds.video`, `embeds.stackBlitz`, `embeds.webContainer` | `false`              | [Embeds](./built-in/embeds.md)                                                             |
...
| Conditional blocks | `conditionalBlocks`                                                                                                                                                                                                                                                | `false`              | [Conditional Blocks](./built-in/conditional-blocks.md)                                     |
| Extra syntax       | `wikiLinks`, `emojiShortcodes`, `attrs`, `crossReferences` / `xrefs`, `citations`, `budoux`, `cjkEmphasis`, `containers`, `badges`, `notByAi`, `keyboardKeys`, `abbreviations`, `definitionLists`, `magicLinks`                                                    | `false`              | [Syntax Extensions](./built-in/syntax-extensions.md)                                       |
...
| Diagrams           | `mermaid`, `graphviz`                                                                                                                                                                                                                                              | `false`              | [Mermaid Diagrams](./built-in/mermaid.md), [Graphviz DOT Diagrams](./built-in/graphviz.md) |
...
| Theme bootstrap    | `renderThemeBootstrapScript`                                                                                                                                                                                                                                       | public API           | [Theme](./theming.md)                                                                      |
