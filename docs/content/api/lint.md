...
<p class="ox-api-entry__source"><a class="ox-api-entry__source-link" href="https://github.com/ubugeeei-prod/ox-content/blob/main/npm/vite-plugin-ox-content/src/lint.ts#L291-L297" target="_blank" rel="noopener noreferrer">View source<span class="ox-api-entry__source-icon" aria-hidden="true"></span></a></p>
...
<p class="ox-api-entry__source"><a class="ox-api-entry__source-link" href="https://github.com/ubugeeei-prod/ox-content/blob/main/npm/vite-plugin-ox-content/src/lint.ts#L302-L309" target="_blank" rel="noopener noreferrer">View source<span class="ox-api-entry__source-icon" aria-hidden="true"></span></a></p>
<div class="ox-api-entry__section ox-api-entry__section--params">
<h4>Parameters</h4>
<ul class="ox-api-entry__params">
<li class="ox-api-entry__param">
...
<h4>Returns</h4>
<div class="ox-api-entry__return">
  <code class="ox-api-entry__return-type">Promise&lt;MarkdownLintResult&gt;</code>
...
<p class="ox-api-entry__source"><a class="ox-api-entry__source-link" href="https://github.com/ubugeeei-prod/ox-content/blob/main/npm/vite-plugin-ox-content/src/lint.ts#L314-L320" target="_blank" rel="noopener noreferrer">View source<span class="ox-api-entry__source-icon" aria-hidden="true"></span></a></p>
<div class="ox-api-entry__section ox-api-entry__section--params">
<h4>Parameters</h4>
<ul class="ox-api-entry__params">
<li class="ox-api-entry__param">
...
<p class="ox-api-entry__source"><a class="ox-api-entry__source-link" href="https://github.com/ubugeeei-prod/ox-content/blob/main/npm/vite-plugin-ox-content/src/lint.ts#L171-L216" target="_blank" rel="noopener noreferrer">View source<span class="ox-api-entry__source-icon" aria-hidden="true"></span></a></p>
...
<p class="ox-api-entry__source"><a class="ox-api-entry__source-link" href="https://github.com/ubugeeei-prod/ox-content/blob/main/npm/vite-plugin-ox-content/src/lint.ts#L71-L94" target="_blank" rel="noopener noreferrer">View source<span class="ox-api-entry__source-icon" aria-hidden="true"></span></a></p>
<div class="ox-api-entry__section ox-api-entry__section--members">
<h4>Members</h4>
<div class="ox-api-entry__member-group">
<h5>Properties</h5>
...
<tr id="markdownlintdictionaryoptions-words">
  ...
  <td><span class="ox-api-entry__member-kind">property</span></td>
  <td><code class="ox-api-entry__member-type language-typescript">string[]</code></td>
  <td><div class="ox-api-entry__member-description">Words ignored across all configured languages.</div></td>
</tr>
<tr id="markdownlintdictionaryoptions-bylanguage">
  ...
  <td><div class="ox-api-entry__member-description">Extra words to allow per language.</div></td>
</tr>
<tr id="markdownlintdictionaryoptions-ignoredwords">
  <td><code>ignoredWords</code><span class="ox-api-badge">optional</span></td>
  <td><span class="ox-api-entry__member-kind">property</span></td>
  <td><code class="ox-api-entry__member-type language-typescript">string[]</code></td>
  <td><div class="ox-api-entry__member-description">Words that should never produce diagnostics.</div></td>
</tr>
<tr id="markdownlintdictionaryoptions-standard">
  <td><code>standard</code><span class="ox-api-badge">optional</span></td>
  <td><span class="ox-api-entry__member-kind">property</span></td>
  <td><code class="ox-api-entry__member-type language-typescript">MarkdownLintStandardDictionaryOptions | false</code></td>
  <td><div class="ox-api-entry__member-description">Opt-in standard dictionary datasets.<br><br>By default the linter stays on a minimal built-in dictionary. Enable this<br>to load larger locale dictionaries from a standard external source.</div></td>
</tr>
</tbody>
</table>
</div>
...
<p class="ox-api-entry__source"><a class="ox-api-entry__source-link" href="https://github.com/ubugeeei-prod/ox-content/blob/main/npm/vite-plugin-ox-content/src/lint.ts#L146-L166" target="_blank" rel="noopener noreferrer">View source<span class="ox-api-entry__source-icon" aria-hidden="true"></span></a></p>
<div class="ox-api-entry__section ox-api-entry__section--members">
<h4>Members</h4>
<div class="ox-api-entry__member-group">
<h5>Properties</h5>
...
<tr id="markdownlintoptions-languages">
  ...
  <td><span class="ox-api-entry__member-kind">property</span></td>
  <td><code class="ox-api-entry__member-type language-typescript">MarkdownLintLanguage[]</code></td>
  <td><div class="ox-api-entry__member-description">Languages enabled for spellchecking.<br><br>When <code>dictionary.standard.languages</code> is provided and this option is<br>omitted, those languages are used instead.</div></td>
</tr>
<tr id="markdownlintoptions-rules">
  <td><code>rules</code><span class="ox-api-badge">optional</span></td>
  <td><span class="ox-api-entry__member-kind">property</span></td>
  <td><code class="ox-api-entry__member-type language-typescript">MarkdownLintRuleOptions</code></td>
  <td><div class="ox-api-entry__member-description">Rule configuration.</div></td>
</tr>
<tr id="markdownlintoptions-dictionary">
  <td><code>dictionary</code><span class="ox-api-badge">optional</span></td>
  <td><span class="ox-api-entry__member-kind">property</span></td>
  <td><code class="ox-api-entry__member-type language-typescript">MarkdownLintDictionaryOptions</code></td>
  <td><div class="ox-api-entry__member-description">Built-in and opt-in standard dictionary overrides.</div></td>
</tr>
</tbody>
</table>
</div>
...
<p class="ox-api-entry__source"><a class="ox-api-entry__source-link" href="https://github.com/ubugeeei-prod/ox-content/blob/main/npm/vite-plugin-ox-content/src/lint.ts#L221-L241" target="_blank" rel="noopener noreferrer">View source<span class="ox-api-entry__source-icon" aria-hidden="true"></span></a></p>
<div class="ox-api-entry__section ox-api-entry__section--members">
<h4>Members</h4>
<div class="ox-api-entry__member-group">
<h5>Properties</h5>
...
<tr id="markdownlintresult-diagnostics">
  ...
  <td><span class="ox-api-entry__member-kind">property</span></td>
  <td><code class="ox-api-entry__member-type language-typescript">MarkdownLintDiagnostic[]</code></td>
...
<p class="ox-api-entry__source"><a class="ox-api-entry__source-link" href="https://github.com/ubugeeei-prod/ox-content/blob/main/npm/vite-plugin-ox-content/src/lint.ts#L99-L141" target="_blank" rel="noopener noreferrer">View source<span class="ox-api-entry__source-icon" aria-hidden="true"></span></a></p>
<div class="ox-api-entry__section ox-api-entry__section--members">
<h4>Members</h4>
<div class="ox-api-entry__member-group">
<h5>Properties</h5>
...
<tr id="markdownlintruleoptions-duplicateheadings">
  ...
  <td><div class="ox-api-entry__member-description">Report headings that repeat the same visible text.</div></td>
</tr>
<tr id="markdownlintruleoptions-headingincrement">
  <td><code>headingIncrement</code><span class="ox-api-badge">optional</span></td>
  <td><span class="ox-api-entry__member-kind">property</span></td>
  <td><code class="ox-api-entry__member-type language-typescript">boolean</code></td>
  <td><div class="ox-api-entry__member-description">Report heading depth jumps such as <code>#</code> -&gt; <code>###</code>.</div></td>
</tr>
<tr id="markdownlintruleoptions-maxconsecutiveblanklines">
  ...
  <td><span class="ox-api-entry__member-kind">property</span></td>
  <td><code class="ox-api-entry__member-type language-typescript">number</code></td>
  <td><div class="ox-api-entry__member-description">Maximum number of blank lines allowed in a row.</div></td>
</tr>
<tr id="markdownlintruleoptions-repeatedpunctuation">
  ...
  <td><span class="ox-api-entry__member-kind">property</span></td>
  <td><code class="ox-api-entry__member-type language-typescript">boolean</code></td>
  <td><div class="ox-api-entry__member-description">Report duplicated terminal punctuation such as <code>!!</code> or <code>？？</code>.</div></td>
</tr>
<tr id="markdownlintruleoptions-repeatedwords">
  <td><code>repeatedWords</code><span class="ox-api-badge">optional</span></td>
  <td><span class="ox-api-entry__member-kind">property</span></td>
  <td><code class="ox-api-entry__member-type language-typescript">boolean</code></td>
  <td><div class="ox-api-entry__member-description">Report adjacent repeated words in visible prose.</div></td>
</tr>
<tr id="markdownlintruleoptions-spellcheck">
  <td><code>spellcheck</code><span class="ox-api-badge">optional</span></td>
  <td><span class="ox-api-entry__member-kind">property</span></td>
  <td><code class="ox-api-entry__member-type language-typescript">boolean</code></td>
  <td><div class="ox-api-entry__member-description">Enable built-in multilingual spellchecking.</div></td>
</tr>
<tr id="markdownlintruleoptions-trailingspaces">
  <td><code>trailingSpaces</code><span class="ox-api-badge">optional</span></td>
  <td><span class="ox-api-entry__member-kind">property</span></td>
  <td><code class="ox-api-entry__member-type language-typescript">boolean</code></td>
  <td><div class="ox-api-entry__member-description">Report trailing spaces.</div></td>
</tr>
</tbody>
</table>
</div>
...
<p class="ox-api-entry__source"><a class="ox-api-entry__source-link" href="https://github.com/ubugeeei-prod/ox-content/blob/main/npm/vite-plugin-ox-content/src/lint.ts#L35-L66" target="_blank" rel="noopener noreferrer">View source<span class="ox-api-entry__source-icon" aria-hidden="true"></span></a></p>
<div class="ox-api-entry__section ox-api-entry__section--members">
<h4>Members</h4>
<div class="ox-api-entry__member-group">
<h5>Properties</h5>
...
<tr id="markdownlintstandarddictionaryoptions-provider">
  ...
  <td><div class="ox-api-entry__member-description">Standard dictionary provider.</div></td>
</tr>
<tr id="markdownlintstandarddictionaryoptions-languages">
  <td><code>languages</code><span class="ox-api-badge">optional</span></td>
  <td><span class="ox-api-entry__member-kind">property</span></td>
  <td><code class="ox-api-entry__member-type language-typescript">MarkdownLintLanguage[]</code></td>
  <td><div class="ox-api-entry__member-description">Languages whose default standard dictionaries should be enabled.<br><br>Built-in preset package mappings currently exist for <code>en</code>, <code>fr</code>, <code>de</code>,<br>and <code>pl</code>. For other languages, use <code>imports</code>.</div></td>
</tr>
<tr id="markdownlintstandarddictionaryoptions-imports">
  <td><code>imports</code><span class="ox-api-badge">optional</span></td>
  <td><span class="ox-api-entry__member-kind">property</span></td>
  <td><code class="ox-api-entry__member-type language-typescript">string[]</code></td>
  <td><div class="ox-api-entry__member-description">Additional CSpell-compatible imports.<br><br>This can point at installed packages like<br><code>@cspell/dict-fr-fr/cspell-ext.json</code> or local CSpell config files.</div></td>
</tr>
<tr id="markdownlintstandarddictionaryoptions-resolveimportsrelativeto">
  ...
  <td><div class="ox-api-entry__member-description">Base URL or path used when resolving <code>imports</code>.</div></td>
</tr>
</tbody>
</table>
</div>
