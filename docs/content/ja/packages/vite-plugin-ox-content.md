...
- 既定: `{ github: true, openGraph: true, pm: false, spotify: false, appleMusic: false, audio: false, video: false, stackBlitz: false, twitter: false, bluesky: false, webContainer: false }`
