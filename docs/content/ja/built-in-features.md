...
| [相互参照](./built-in/cross-references.md)                 | セクション、図、表への label 付きリンク                                        |
| [引用](./built-in/citations.md)                            | CSL JSON に基づく引用と生成 bibliography entry                                 |
| [BudouX](./built-in/budoux.md)                             | 日本語改行向けのビルド時フレーズ分割                                           |
...
| [Graphviz DOT](./built-in/graphviz.md)                     | DOT graph フェンスをサニタイズ済み静的 SVG に描画                              |
...
| [独自ホスト lifecycle](./built-in/custom-host.md)          | 独自 HTML ホスト向けの Vite loading、dev routing、invalidation、書き出し       |
| [Document assets](./built-in/document-assets.md)           | script、style、link、manifest、self-hosted asset の typed tag                  |
...
| 独自 HTML ホスト      | `oxContentCustomHost`                                                                                                                                                                                                                                              | 公開 API           | [独自ホスト lifecycle](./built-in/custom-host.md)                        |
| Document assets       | `renderDocumentAssets`                                                                                                                                                                                                                                             | 公開 API           | [Document assets](./built-in/document-assets.md)                         |
| 独自ホストの SSG 出力 | `planSsgOutputs`、`writeResourceFiles`、`writeMarkdownCompanions`、`renderFeedFiles`、`writeFeedFiles`、`writeSiteMapFiles`                                                                                                                                        | 公開 API           | [SSG 出力プリミティブ](./built-in/ssg-output.md)                         |
...
| オプトイン埋め込み    | `embeds.pm`, `embeds.twitter`, `embeds.reddit`, `embeds.bluesky`, `embeds.qiita`, `embeds.zenn`, `embeds.packageRegistry`, `embeds.spotify`, `embeds.appleMusic`, `embeds.speakerDeck`, `embeds.audio`, `embeds.video`, `embeds.stackBlitz`, `embeds.webContainer` | `false`            | [埋め込み](./built-in/embeds.md)                                         |
...
| 追加構文              | `wikiLinks`, `emojiShortcodes`, `attrs`, `crossReferences` / `xrefs`, `citations`, `budoux`, `cjkEmphasis`, `containers`, `badges`, `notByAi`, `keyboardKeys`, `abbreviations`, `definitionLists`, `magicLinks`                                                    | `false`            | [構文拡張](./built-in/syntax-extensions.md)                              |
...
| 図                    | `mermaid`, `graphviz`                                                                                                                                                                                                                                              | `false`            | [Mermaid](./built-in/mermaid.md), [Graphviz DOT](./built-in/graphviz.md) |
...
| Theme bootstrap       | `renderThemeBootstrapScript`                                                                                                                                                                                                                                       | 公開 API           | [テーマ](./theming.md)                                                   |
