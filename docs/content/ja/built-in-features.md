...
| 追加構文              | `wikiLinks`, `emojiShortcodes`, `attrs`, `crossReferences` / `xrefs`, `citations`, `cjkEmphasis`, `containers`, `badges`, `notByAi`, `keyboardKeys`, `abbreviations`, `definitionLists`, `magicLinks`                                                              | `false`            | [構文拡張](./built-in/syntax-extensions.md)                              |
