...
| 追加構文              | `wikiLinks`, `emojiShortcodes`, `attrs`, `cjkEmphasis`, `containers`, `badges`, `notByAi`, `keyboardKeys`, `abbreviations`, `magicLinks` | `false`            | [構文拡張](./built-in/syntax-extensions.md)              |
