...
| オプトイン埋め込み    | `embeds.pm`, `embeds.twitter`, `embeds.bluesky`, `embeds.spotify`, `embeds.appleMusic`, `embeds.audio`, `embeds.video`, `embeds.stackBlitz`, `embeds.webContainer` | `false`            | [埋め込み](./built-in/embeds.md)                         |
...
| 追加構文              | `wikiLinks`, `emojiShortcodes`, `attrs`, `cjkEmphasis`, `containers`, `badges`, `notByAi`, `keyboardKeys`, `definitionLists`, `magicLinks`                                            | `false`            | [構文拡張](./built-in/syntax-extensions.md)              |
