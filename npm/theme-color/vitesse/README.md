# @ox-content/theme-color-vitesse

Vitesse — Anthony Fu's Vitesse light and dark — for [Ox Content](https://github.com/ubugeeei-prod/ox-content).
...
```bash
npm install @ox-content/theme-color-vitesse
```
...
import vitesse from "@ox-content/theme-color-vitesse";

export default defineConfig({
  plugins: [
    oxContent({
      srcDir: "docs",
      ssg: { siteName: "My Docs", theme: vitesse },
    }),
  ],
});
```
