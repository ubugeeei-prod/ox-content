...
export const catppuccin: ThemeConfig = {
  ...
  tokens: {
    ...
    "shiki-token-comment": "color-mix(in srgb, #4c4f69 55%, #e6e9ef)",
    "shiki-token-punctuation": "color-mix(in srgb, #4c4f69 72%, #e6e9ef)",
    "shiki-token-keyword": "#8839ef",
    "shiki-token-string": "#40a02b",
    "shiki-token-string-expression": "#40a02b",
    "shiki-token-constant": "#df8e1d",
    "shiki-token-function": "#1e66f5",
    "shiki-token-parameter": "#d20f39",
  ...
  darkTokens: {
    ...
    "shiki-background": "#11111b",
    "shiki-token-comment": "color-mix(in srgb, #cdd6f4 55%, #11111b)",
    "shiki-token-punctuation": "color-mix(in srgb, #cdd6f4 72%, #11111b)",
    "shiki-token-keyword": "#cba6f7",
    "shiki-token-string": "#a6e3a1",
    "shiki-token-string-expression": "#a6e3a1",
    "shiki-token-constant": "#f9e2af",
    "shiki-token-function": "#89b4fa",
    "shiki-token-parameter": "#f38ba8",
    "shiki-token-link": "#94e2d5",
  },
};
