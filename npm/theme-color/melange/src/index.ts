...
export const melange: ThemeConfig = {
  ...
  tokens: {
    ...
    "shiki-foreground": "#54433a",
    "shiki-background": "#e9e1db",
    "shiki-token-comment": "color-mix(in srgb, #54433a 55%, #e9e1db)",
    "shiki-token-punctuation": "color-mix(in srgb, #54433a 72%, #e9e1db)",
    "shiki-token-keyword": "#8a5570",
    "shiki-token-string": "#5c6f3f",
    "shiki-token-string-expression": "#5c6f3f",
    "shiki-token-constant": "#8a6f2a",
    "shiki-token-function": "#5a6b8a",
    "shiki-token-parameter": "#a8503a",
    "shiki-token-link": "#4f7068",
  },
  darkTokens: {
    ...
    "shiki-foreground": "#ece1d7",
    "shiki-background": "#211f1c",
    "shiki-token-comment": "color-mix(in srgb, #ece1d7 55%, #211f1c)",
    "shiki-token-punctuation": "color-mix(in srgb, #ece1d7 72%, #211f1c)",
    "shiki-token-keyword": "#cf9bc2",
    "shiki-token-string": "#85b695",
    "shiki-token-string-expression": "#85b695",
    "shiki-token-constant": "#ebc06d",
    "shiki-token-function": "#a3a9ce",
    "shiki-token-parameter": "#d47766",
    "shiki-token-link": "#89b3b6",
  },
};
