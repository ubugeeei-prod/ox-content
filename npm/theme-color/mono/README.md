# @ox-content/theme-color-mono

Mono — Pure monochrome, zero hue — for [Ox Content](https://github.com/ubugeeei-prod/ox-content).
...
```bash
npm install @ox-content/theme-color-mono
```
...
import mono from "@ox-content/theme-color-mono";

export default defineConfig({
  plugins: [
    oxContent({
      srcDir: "docs",
      ssg: { siteName: "My Docs", theme: mono },
    }),
  ],
});
```
...
theme: [pixel, mono, { colors: { primary: "#ff5f56" } }];
```
