...
export const rosePine: ThemeConfig = {
  ...
  darkTokens: {
    ...
    "syntax-background": "#16141f",
    "syntax-token-comment": "color-mix(in srgb, #e0def4 55%, #16141f)",
    "syntax-token-punctuation": "color-mix(in srgb, #e0def4 72%, #16141f)",
    "syntax-token-keyword": "#c4a7e7",
    "syntax-token-string": "#31748f",
    "syntax-token-string-expression": "#31748f",
    "syntax-token-constant": "#f6c177",
    "syntax-token-function": "#9ccfd8",
    "syntax-token-parameter": "#eb6f92",
    "syntax-token-link": "#9ccfd8",
  },
};
