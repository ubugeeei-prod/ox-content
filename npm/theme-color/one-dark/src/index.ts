...
export const oneDark: ThemeConfig = {
  ...
  tokens: {
    ...
    "shiki-background": "#eaeaeb",
    "shiki-token-comment": "color-mix(in srgb, #383a42 55%, #eaeaeb)",
    "shiki-token-punctuation": "color-mix(in srgb, #383a42 72%, #eaeaeb)",
    "shiki-token-keyword": "#a626a4",
    "shiki-token-string": "#50a14f",
    "shiki-token-string-expression": "#50a14f",
    "shiki-token-constant": "#c18401",
  ...
  darkTokens: {
    ...
    "shiki-background": "#21252b",
    "shiki-token-comment": "color-mix(in srgb, #abb2bf 55%, #21252b)",
    "shiki-token-punctuation": "color-mix(in srgb, #abb2bf 72%, #21252b)",
    "shiki-token-keyword": "#c678dd",
    "shiki-token-string": "#98c379",
    "shiki-token-string-expression": "#98c379",
    "shiki-token-constant": "#e5c07b",
