...
export const iceberg: ThemeConfig = {
  ...
  tokens: {
    ...
    "shiki-foreground": "#33374c",
    "shiki-background": "#dcdfe7",
    "shiki-token-comment": "color-mix(in srgb, #33374c 55%, #dcdfe7)",
    "shiki-token-punctuation": "color-mix(in srgb, #33374c 72%, #dcdfe7)",
    "shiki-token-keyword": "#7759b4",
    "shiki-token-string": "#668e3d",
    "shiki-token-string-expression": "#668e3d",
    "shiki-token-constant": "#c57339",
    "shiki-token-function": "#2d539e",
    "shiki-token-parameter": "#cc517a",
    "shiki-token-link": "#3f83a6",
  },
  darkTokens: {
    ...
    "shiki-foreground": "#c6c8d1",
    "shiki-background": "#0f1117",
    "shiki-token-comment": "color-mix(in srgb, #c6c8d1 55%, #0f1117)",
    "shiki-token-punctuation": "color-mix(in srgb, #c6c8d1 72%, #0f1117)",
    "shiki-token-keyword": "#a093c7",
    "shiki-token-string": "#b4be82",
    "shiki-token-string-expression": "#b4be82",
    "shiki-token-constant": "#e2a478",
    "shiki-token-function": "#84a0c6",
    "shiki-token-parameter": "#e27878",
    "shiki-token-link": "#89b8c2",
  },
};
