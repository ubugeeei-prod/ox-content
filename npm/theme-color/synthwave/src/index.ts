...
export const synthwave: ThemeConfig = {
  ...
  tokens: {
    ...
    "shiki-foreground": "#ffe6ff",
    "shiki-background": "#241b2f",
    "shiki-token-comment": "color-mix(in srgb, #ffe6ff 55%, #241b2f)",
    "shiki-token-punctuation": "color-mix(in srgb, #ffe6ff 72%, #241b2f)",
    "shiki-token-keyword": "#ff7edb",
    "shiki-token-string": "#72f1b8",
    "shiki-token-string-expression": "#72f1b8",
    "shiki-token-constant": "#fede5d",
    "shiki-token-function": "#36f9f6",
    "shiki-token-parameter": "#fe4450",
  ...
  darkTokens: {
    ...
    "shiki-foreground": "#ffe6ff",
    "shiki-background": "#1a1425",
    "shiki-token-comment": "color-mix(in srgb, #ffe6ff 55%, #1a1425)",
    "shiki-token-punctuation": "color-mix(in srgb, #ffe6ff 72%, #1a1425)",
    "shiki-token-keyword": "#ff7edb",
    "shiki-token-string": "#72f1b8",
    "shiki-token-string-expression": "#72f1b8",
    "shiki-token-constant": "#fede5d",
