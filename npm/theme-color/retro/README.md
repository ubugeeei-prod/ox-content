# @ox-content/theme-color-retro

Retro — Warm amber phosphor terminal — for [Ox Content](https://github.com/ubugeeei-prod/ox-content).
...
```bash
npm install @ox-content/theme-color-retro
```
...
import retro from "@ox-content/theme-color-retro";

export default defineConfig({
  plugins: [
    oxContent({
      srcDir: "docs",
      ssg: { siteName: "My Docs", theme: retro },
    }),
  ],
});
```
...
theme: [pixel, retro, { colors: { primary: "#ff5f56" } }];
```
