...
export const slate: ThemeConfig = {
  ...
  tokens: {
    ...
    "shiki-foreground": "#e6e9ef",
    "shiki-background": "#14181f",
    "shiki-token-comment": "color-mix(in srgb, #e6e9ef 55%, #14181f)",
    "shiki-token-punctuation": "color-mix(in srgb, #e6e9ef 72%, #14181f)",
    "shiki-token-keyword": "#b190f2",
    "shiki-token-string": "#b6e84f",
    "shiki-token-string-expression": "#b6e84f",
    "shiki-token-constant": "#e9c86a",
    "shiki-token-function": "#77a8f0",
    "shiki-token-parameter": "#f27c88",
    "shiki-token-link": "#57cbd8",
  },
  darkTokens: {
    ...
    "shiki-foreground": "#e6e9ef",
    "shiki-background": "#0a0d10",
    "shiki-token-comment": "color-mix(in srgb, #e6e9ef 55%, #0a0d10)",
    "shiki-token-punctuation": "color-mix(in srgb, #e6e9ef 72%, #0a0d10)",
    "shiki-token-keyword": "#b190f2",
    "shiki-token-string": "#b6e84f",
    "shiki-token-string-expression": "#b6e84f",
    "shiki-token-constant": "#e9c86a",
