...
Voltage — High-voltage accents over a near-black canvas — for [Ox Content](https://github.com/ubugeeei-prod/ox-content).
...
```bash
npm install @ox-content/theme-color-voltage
```
...
theme: [pixel, voltage, { colors: { primary: "#ff5f56" } }];
```
