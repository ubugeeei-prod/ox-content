...
export const arctic: ThemeConfig = {
  ...
  tokens: {
    ...
    "shiki-foreground": "#e4eef2",
    "shiki-background": "#0f1a1f",
    "shiki-token-comment": "color-mix(in srgb, #e4eef2 55%, #0f1a1f)",
    "shiki-token-punctuation": "color-mix(in srgb, #e4eef2 72%, #0f1a1f)",
    "shiki-token-keyword": "#ae9ae0",
    "shiki-token-string": "#7ecaa5",
    "shiki-token-string-expression": "#7ecaa5",
    "shiki-token-constant": "#e0c184",
    "shiki-token-function": "#82b0e2",
    "shiki-token-parameter": "#ef8590",
    "shiki-token-link": "#6fd0e0",
  },
  darkTokens: {
    ...
    "shiki-foreground": "#e4eef2",
    "shiki-background": "#070d10",
    "shiki-token-comment": "color-mix(in srgb, #e4eef2 55%, #070d10)",
    "shiki-token-punctuation": "color-mix(in srgb, #e4eef2 72%, #070d10)",
    "shiki-token-keyword": "#ae9ae0",
    "shiki-token-string": "#7ecaa5",
    "shiki-token-string-expression": "#7ecaa5",
    "shiki-token-constant": "#e0c184",
